...
import DataUploadAndCleaning from "./financial-insights/DataUploadAndCleaning";
    ...
    <div className="space-y-6">
      ...
      <div>
        ...
        <p className="text-muted-foreground mt-2">
          智能毛利润分析系统 - 完整的财务数据处理流程：数据上传与清洗 → 成本设置 → 利润分析
        </p>
      </div>
      ...
      <Tabs value={activeTab} onValueChange={setActiveTab}>
        ...
        <TabsContent value="upload" className="mt-6">
          <DataUploadAndCleaning onAnalysisComplete={handleAnalysisComplete} />
        </TabsContent>
